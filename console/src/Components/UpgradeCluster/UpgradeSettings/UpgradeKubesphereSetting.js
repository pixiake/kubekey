...
const UpgradeKubesphereSetting = () => {
    ...
    return (
        <div>
            <Columns>
                <Column className={'is-2'}>是否升级 KubeSphere:</Column>
                <Column>
            ...
            <Columns>
                ...
                <Column>
                    <Select placeholder="Kubesphere可选版本与K8s集群版本有关" value={ksVersion} options={KubesphereVersionOptions} disabled={false} onChange={changeKubesphereVersionHandler} />
                </Column>
            </Columns>
        </div>
    );
